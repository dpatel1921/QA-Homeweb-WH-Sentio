...
namespace WarriorHealthBeta.Objects
{
    internal class WarriorHealthObjects
    {
        ...
        [FindsBy(How = How.XPath, Using = "//div[@title='NAVIGATIO​N SUPPORT CHAT']")]
        ...
        [FindsBy(How = How.XPath, Using = "//img[@alt='Image for Sentio iCBT: Online Self-Guided Cognitive Behaviour Therapy for Public Safety Personnel & Families']")]
        ...
        [FindsBy(How = How.XPath, Using = "//div[@class='partners']//img[@alt='Wounded Warriors']")]
        public IWebElement Aboutus2 { get; set; }
        [FindsBy(How = How.XPath, Using = "//div[@class='partners']//img[@alt='Homewood Health']")]
        public IWebElement Aboutus3 { get; set; }
        [FindsBy(How = How.XPath, Using = "//div[@class='partners']//img[@alt='Trillium Health Partners']")]
        public IWebElement Aboutus4 { get; set; }
        [FindsBy(How = How.XPath, Using = "//div[@class='partners']//img[@alt='Centre for Addiction and Mental Health']")]
        public IWebElement Aboutus5 { get; set; }
        [FindsBy(How = How.XPath, Using = "//div[@class='partners']//img[@alt='Boots on the Ground']")]
        ...
        [FindsBy(How = How.XPath, Using = "//BUTTON[@class='btn btn-primary'][text()='Get Started']")]
        public IWebElement Assessment1 { get; set; }
        [FindsBy(How = How.XPath, Using = "//BUTTON[@type='button'][text()=' Start Screening Measures ']")]
        ...
        [FindsBy(How = How.XPath, Using = "//BUTTON[@role='button'][text()='Next']")]
        public IWebElement Next { get; set; }

        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='No'])[1]")]
        public IWebElement Assessment4 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='No'])[2]")]
        public IWebElement Assessment5 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='No'])[3]")]
        public IWebElement Assessment6 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='No'])[4]")]
        public IWebElement Assessment7 { get; set; }
        [FindsBy(How = How.XPath, Using = "//button[normalize-space()='Very Good']")]
        public IWebElement Assessment8 { get; set; }
        [FindsBy(How = How.XPath, Using = "//P[@class='card-title'][text()='Financial Fitness']")]
        public IWebElement Assessment9 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Neutral'])[1]")]
        public IWebElement Assessment10 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Neutral'])[2]")]
        public IWebElement Assessment11 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Neutral'])[3]")]
        public IWebElement Assessment12 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Neutral'])[4]")]
        public IWebElement Assessment13 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Neutral'])[5]")]
        public IWebElement Assessment14 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Neutral'])[6]")]
        public IWebElement Assessment15 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Never'])[1]")]
        public IWebElement Assessment16 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Never'])[2]")]
        public IWebElement Assessment17 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Never'])[3]")]
        public IWebElement Assessment18 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Never'])[4]")]
        public IWebElement Assessment19 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Never'])[5]")]
        public IWebElement Assessment20 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Never'])[6]")]
        public IWebElement Assessment21 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[1]")]
        public IWebElement Assessment22 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[2]")]
        public IWebElement Assessment23 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[3]")]
        public IWebElement Assessment24 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[4]")]
        public IWebElement Assessment25 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[5]")]
        public IWebElement Assessment26 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[6]")]
        public IWebElement Assessment27 { get; set; }
        [FindsBy(How = How.XPath, Using = "(//BUTTON[@role='button'][text()='Did not apply to me at all'])[7]")]
        ...
        [FindsBy(How = How.XPath, Using = "//a[normalize-space(text())='Visit our website']")]

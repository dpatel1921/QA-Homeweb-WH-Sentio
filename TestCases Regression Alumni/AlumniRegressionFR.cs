...
{
    [TestFixture]
    public class AlumniRegressionFR
    {
        ...
        public void AlumniAddictionFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
            var RegObj = new AlumniRegressionObjectsFR();
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniLifeSkillsFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniRelationshipsFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniRecoveryFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniWellnessTogetherFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniHealingwithHomewoodFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniGettingStartedFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniWebinarsFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniCrisisFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniCovidFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);
            ...
            ClickAndNavigate(RegObj.AlumniCovidtag);
            Thread.Sleep(1000);
            ScrollToElement(RegObj.AlumniCovid18);
            Thread.Sleep(1000);

            ClickAndNavigate(RegObj.AlumniCovid18);
            Thread.Sleep(1000);
            ScrollToElement(RegObj.AlumniCovidtag);
            Thread.Sleep(1000);
            ClickAndNavigate(RegObj.AlumniCovidtag);
        ...
        [Test, TestCaseSource(nameof(LoginJsonData))]
        public void AlumniMentalHealthFR(string AlumniUsername, string AlumniPassword, string Url)
        {
            driver.Navigate().GoToUrl(Url);
            var homePage = new HomewebLoginObjects();
            PageFactory.InitElements(driver, homePage);

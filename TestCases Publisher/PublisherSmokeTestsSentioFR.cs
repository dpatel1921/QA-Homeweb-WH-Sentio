...
namespace Homeweb_3._0_Tests.TestCases
{
    ...
    public class PublisherSmokeTestsSentioFR
    {
        ...
        public void PubDashboardSentioFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            ...
            Thread.Sleep(1000);
            ScrollToElement(homePage.ViewActivitiesFR);
            Assert.IsTrue(homePage.ViewActivitiesFR.Displayed, "Activities tab should be visible.");
            homePage.ViewActivitiesFR.Click();


            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewDashboardFR.Displayed, "Dashboard should be visible.");
            homePage.ViewDashboardFR.Click();

            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewCoursesFR.Displayed, "Courses tab should be visible.");
            homePage.ViewCoursesFR.Click();
            ...
            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewProgramsFR.Displayed, "Programs tab should be visible.");
            homePage.ViewProgramsFR.Click();

            Thread.Sleep(1000);
            homePage.ViewDashboardFR.Click();

            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewPagesFR.Displayed, "Pages tab should be visible.");
            homePage.ViewPagesFR.Click();
            ...
            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewDashboardFR.Displayed, "Dashboard should still be visible after Assets.");
            homePage.ViewDashboardFR.Click();
        }

        [Test, TestCaseSource(nameof(LoginJsonData)), Order(2)]
        public void PubDashboardSentioActivitesADDFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.DoesNotThrow(() => new SelectElement(activitytype).SelectByText("Ressource"),
            ...
            Assert.DoesNotThrow(() => new SelectElement(activityformat).SelectByText("Texte"),
        ...
        public void PubDashboardSentioActivitesPreviewFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
        ...
        public void PubDashboardSentioActivitesEditFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.ActivityEditFR.Displayed, "Edit button should be visible for the activity.");
            ...
            Assert.IsTrue(homePage.ActivityEditdetailsFR.Displayed, "Edit details button should be visible on the edit page.");
            homePage.ActivityEditdetailsFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioActivitesDeleteFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.ActivityEditDeleteFR.Displayed, "Delete button should be visible for the activity.");
            homePage.ActivityEditDeleteFR.Click();
            Thread.Sleep(2000);

            homePage.ActivityEditDeleteconfirm1FR.Click();
            Thread.Sleep(2000);

        }
        [Test, TestCaseSource(nameof(LoginJsonData)), Order(6)]
        public void PubDashboardSentioCoursesADDFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            ScrollToElement(homePage.ViewCoursespubFR);
            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewCoursespubFR.Displayed, "Courses tab should be visible.");
            homePage.ViewCoursespubFR.Click();
            Thread.Sleep(1000);


            Assert.IsTrue(homePage.CoursesaddFR.Displayed, "Add Course button should be visible on Courses page.");
        ...
        public void PubDashboardSentioCoursesPreviewFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
        ...
        public void PubDashboardSentioCoursesEditFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.ActivityEditFR.Displayed, "Edit button should be visible for the course.");
            homePage.ActivityEditFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioCoursesDeleteFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.ActivityEditDeleteFR.Displayed, "Delete button should be visible for the course.");
            homePage.ActivityEditDeleteFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioProgramsADDFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            ScrollToElement(homePage.ViewProgramspubFR);
            Thread.Sleep(1000);
            Assert.IsTrue(homePage.ViewProgramspubFR.Displayed, "Programs tab should be visible.");
            homePage.ViewProgramspubFR.Click();
            Thread.Sleep(1000);


            Assert.IsTrue(homePage.CoursesaddFR.Displayed, "Add Program button should be visible on Programs page.");
            homePage.CoursesaddFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioProgramsPreviewFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
        ...
        public void PubDashboardSentioProgramsEditFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.ActivityEditFR.Displayed, "Edit button should be visible for the program.");
            homePage.ActivityEditFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioProgramsDeleteFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.ActivityEditDeleteFR.Displayed, "Delete button should be visible for the program.");
            homePage.ActivityEditDeleteFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioPagesADDFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.CoursesaddFR.Displayed, "Add Page button should be visible on Pages page.");
            homePage.CoursesaddFR.Click();
            Thread.Sleep(1000);
        ...
        public void PubDashboardSentioPagesPreviewFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
        ...
        public void PubDashboardSentioPagesEditFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.PageeditFR.Displayed, "Page edit section/button should be visible.");
        ...
        public void PubDashboardSentioPagesDeleteFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
        ...
        public void PubDashboardSentioAssetsADDFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
            ...
            Assert.IsTrue(homePage.CoursesaddFR.Displayed, "Add Asset button should be visible on Assets page.");
            homePage.CoursesaddFR.Click();
            Thread.Sleep(2000);
        ...
        public void PubDashboardSentioAssetsEditFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
        ...
        public void PubDashboardSentioAssetsDeleteFR(string PubEmail, string PubPassword, string PubUrl, string PubActivityName)
        {
            // Navigate to the provided URL
            driver.Navigate().GoToUrl(PubUrl);
            var homePage = new HomewebLoginObjects();
